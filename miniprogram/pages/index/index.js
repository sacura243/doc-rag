...
Page({
  data: { documentCount: 0, chunkCount: 0, questionCount: 0, question: '', answer: '', loading: false },
  ...
  askQuestion() {
    ...
    request({ path: '/chat', method: 'POST', data: { question, top_k: 4 } })
      .then(result => this.setData({ answer: result.answer, questionCount: this.data.questionCount + 1 }))
